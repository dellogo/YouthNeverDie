...
import com.example.youthneverdie.databinding.ActivityWorkFdetailBinding
import com.example.youthneverdie.databinding.CommentListItemBinding
import com.example.youthneverdie.utils.FirebaseAuth
import com.example.youthneverdie.utils.FirebaseReF
import com.google.firebase.database.*

class WorkFDetailActivity : AppCompatActivity() {
    private val TAG = WorkFDetailActivity::class.java.simpleName
    private lateinit var binding : ActivityWorkFdetailBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_work_fdetail)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_work_fdetail)
